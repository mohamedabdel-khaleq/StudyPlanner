...
const AddScreen = () => {
  ...
  const handleAddProject = (): void => {
    const finalName = projectName.trim() || `Task ${taskCounter}`;
    const dateISO = formatDateToISO(startDate);
    ...
    Alert.alert('Success', `Task "${finalName}" added successfully!`);
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.card}>
            <View style={styles.textContainer}>
              ...
              <TextInput
                style={[styles.descriptionValue, styles.textArea]}
                value={description}
            ...
            <View style={styles.dropdownModalContent}>
              {taskGroups.map((group) => (
                <TouchableOpacity
                  ...
                  onPress={() => { setSelectedGroup(group); setShowGroupDropdown(false); }}
                >
